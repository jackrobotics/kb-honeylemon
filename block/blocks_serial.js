...
Blockly.Blocks['serial_hardware_init'] = {
  init: function() {
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldDropdown([["115200","115200"], ["300","300"], ["600","600"], ["1200","1200"], ["2400","2400"], ["4800","4800"], ["9600","9600"], ["14400","14400"], ["19200","19200"], ["28800","28800"], ["38400","38400"], ["57600","57600"]]), "baudrate")
        .appendField("RX pin")
        .appendField(new Blockly.FieldNumber(25, 0, 50), "rx")
        .appendField("TX pin")
        .appendField(new Blockly.FieldNumber(26, 0, 50), "tx")
        .appendField(new Blockly.FieldDropdown([["Serial1","Serial1"]]), "type");
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(180);
 this.setTooltip("begin using Hardware Serial1");
 this.setHelpUrl("");
  }
};
...
Blockly.Blocks['serial_available'] = {
  init: function() {
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldDropdown([["UsbSerial","Serial"], ["Serial1","Serial1"]]), "type");
    this.setInputsInline(true);
